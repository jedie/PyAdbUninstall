...
setuptools.setup(
    ...
    description="Thinker GUI for uninstall Android bloatware Apps via 'adb' without root.",
    long_description=long_description,
    url="https://github.com/jedie/PyAdbUninstall",
    packages=setuptools.find_packages(),
    python_requires=">=3.5",
    # install_requires=["adb"],
    classifiers=[
    ...
    entry_points={
        "console_scripts": [
            # run the dev. server:
            "adb_uninstall = adb_uninstall.gui:main"
        ]
    },
)
